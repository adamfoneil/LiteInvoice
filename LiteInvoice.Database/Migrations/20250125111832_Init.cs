        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddToInvoice = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoicesLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoicesLinks_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    StaticLink = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Instructions = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    StripeConfigPaymentMethodId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StripeData", x => x.PaymentMethodId);
                    table.ForeignKey(
                        name: "FK_StripeData_PaymentMethods_PaymentMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicesLinks_InvoiceId",
                table: "InvoicesLinks",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_BusinessId_Name",
                table: "PaymentMethods",
                columns: new[] { "BusinessId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_StripeConfigPaymentMethodId",
                table: "PaymentMethods",
                column: "StripeConfigPaymentMethodId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PaymentMethods_StripeData_StripeConfigPaymentMethodId",
                table: "PaymentMethods",
                column: "StripeConfigPaymentMethodId",
                principalTable: "StripeData",
